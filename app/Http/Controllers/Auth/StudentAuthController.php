...
class StudentAuthController extends Controller
{
    ...
    public function Register(Request $request)
    {
        ...
        $validated = FacadesValidator::make($request->all(), [
            ...
            'attended_som_before' => 'required|string',
            'where_attended' => 'required_if:attended_som_before,yes|string',
            'participation_mode' => 'required|string',
            'ln_member' => 'required|string',
            'ministry' => 'required_if:ln_member,yes|string',
