    ...
    <body>
        <div style="display: flex; flex-direction: row">
            ...
            <div>
                ...
                <div>
                    <div>Dear {{ $profile['first_name'] }} {{ $profile['last_name'] }},</div>
                    <br>
                    <h2 style="text-align: center">Letter Of Admission</h2>
                    <div>
                        We are so excited to welcome you to International School of Ministry 2024!
                    </div>
                    ...
                    <div>Your Registration number is <b>{{ $reg_no }}</b></div>
                    ...
                    <div>On-site classes hold at: Sphere of Light Church Auditorium, Oshuntokun Avenue, Bodija,
                        Ibadan. Off-site classes will be streamed online and you can attend at the comfort of your home
                        or
                        office or anywhere.</div>
                    <div>The session will run from April 12th - June 15th 2024. Lectures commences on Friday, 12th April
                        2024 with an introductory/Orientation class. The course schedule and curriculum for the entire
                    ...
                    <div>For further enquires and questions: 09030959735.</div>
                </div>
                ...
                <div>
                    <a href="flamefemilazarus2021@gmail.com">flamefemilazarus2021@gmail.com</a>
                    <br>
                    +2349030959735
                    <br>
                    +2348104551287
                    <br>
                    Former fun factory, Oshuntokun Avenue, Bodija, Ibadan
                </div>
            </div>
        </div>
